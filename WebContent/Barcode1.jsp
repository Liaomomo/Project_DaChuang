		 	...
		 	<div class="text-wrap">
				<div class="toolbar">
					...
					<div class="toolbar2 clearf">
						<a class="nav_list" title="page_4" href="#"  ><img  src="../static/imgs/mic-ph.png" alt="语音">语音</a>
...
<!-- 						<ahref="#" ><img src="card.png" alt="名片"></a>
 -->					</div>
				...
				<div class="textArea-box clearf page" id="page_3">
					<form  action="../code/CreateCode.do" method="post" id="form_statis_text">
						<textarea id="text_content" class="main_text" name="text"  placeholder="请输入内容" ></textarea>
							<div class="div_two" >
							<input type="button" class="btns" style="margin-top:160px"  id="statis_id" value="生成静态码" />
				...
				<div class="textArea-box clearf page" id="page_5" style="display:none;">
					<form  action="./code/CreateCode.do" method="post" id="form_05" >
						<div>
							...
							<input type="button" class="btns" style="margin-top:20px" id="statis_id" value="生成静态码" />
							<input type="button" class="btns" id="dymantis_id" value="生成动态码"/>
					</form>
				</div>
				<!-- 6.微信 -->
...
<!--静态文本二维码-->
$("#statis_id").click(function(){
	
	if($("#text_content").val()!=""){   
		$("#form_statis_text").submit(); 
	}else{
		alert("请输入内容");
	}
});
