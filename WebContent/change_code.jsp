...
<head>
	...
	<link rel="stylesheet" href="../static/css/change_code.css">
	<style>
		.selected{
...
<!-- 						<ahref="#" ><img src="card.png" alt="名片"></a>
 -->					</div>
				...
				<div class="textArea-box clearf page" style="display: none; height:auto"id="page_1" >
					<form  action="../code/updata_code_data.do" method="post" id="form_img" enctype="multipart/form-data">
						<div >
						...
						<div class="div_Singular" >
						   <input type="button" class="btns_Singular"  id="img_id" value="保存修改" />
						</div>
				...
				<div class="textArea-box clearf page" style="display: none; height:auto"id="page_2" >
					<form  action="../code/updata_code_data.do" method="post" id="form_02" class="form_video" enctype="multipart/form-data">
						<div >
						...
						<div class="div_Singular" >
						   <input type="button" class="btns_Singular"  id="video_id" value="保存修改" />
						</div>
				...
				<div class="textArea-box clearf page" id="page_4" style="display:none;">
					<form  action="../code/updata_code_data.do" method="post" id="form_04" class="form_data" enctype="multipart/form-data" >
    					...
    					<div id="fileType"></div>
    					<div class="div_Singular" >
						   <input type="button" class="btns_Singular"  id="data_id" value="保存修改" />
						</div>
				...
				<div class="textArea-box clearf page" id="page_5" style="display:none;">
					<form  action="./code/updata_code_str.do" method="post" id="form_05" >
						<div>
							...
							<div class="div_Singular" >
						   <input type="button" class="btns_Singular"  id="web_id" value="保存修改" />
						</div>
				...
				<div class="textArea-box clearf page" id="page_6" style="display:none;">
					<form  action="./code/updata_code_stre.do" method="post" id="form_06">
						...
						<div class="div_Singular" >
						   <input type="button" class="btns_Singular"  id="weixin_id" value="保存修改" />
						</div>
					</form>
				</div>
...
$(function(){
	...
	if(type =='text'){
		...
		<!--$("#text_content").append("<textarea id='change_content' style='width:300px;height:160px;font-size:16px;margin:3% auto;display:block'>"+'${text}'+"</textarea>");-->$("#text_content").append("<textarea id='change_content' style='width:300px;height:160px;font-size:16px;margin:3% auto;display:block'>"+'${text}'+"</textarea>");
