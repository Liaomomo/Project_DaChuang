...
<!-- 						<ahref="#" ><img src="card.png" alt="名片"></a>
 -->					</div>
		...
		<div class="bottom-nav clearf">
			<a href="index.jsp" class="f_left w-50 clearf"><img src="static/imgs/home.png" alt="主页"></a>
			<button class="clearf"  id="jitiao" style="cursor:pointer"><img src="static/imgs/code.png" alt="二维码生成按钮"><b>一键生成</span></button>
 			<a href="user.jsp" class="f_right w-50  "><img class="icon-user" src="static/imgs/user.png" alt="个人中心"></a>
		</div>
	</div>
</body>
